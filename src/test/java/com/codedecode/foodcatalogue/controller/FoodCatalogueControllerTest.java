...
class FoodCatalogueControllerTest {
    ...
    void addFoodItem_ShouldReturnCreatedStatus() {
        ...
        //times(1): This specifies the number of times the method should have been called.
        // In this case, you're checking that addFoodItem(foodItemDTO) was called exactly once.
