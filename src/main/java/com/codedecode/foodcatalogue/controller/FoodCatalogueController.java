...
public class FoodCatalogueController {
    ...
    // be careful, in the getMapping {restaurantId} should exactly match with the @PathVariable Integer restaurantId
    //otherwise it cannot read the {restaurantId} from the url
